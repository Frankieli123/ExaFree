...
2. **合规义务**：使用者必须遵守所在地法律法规及第三方服务条款（包括但不限于 Exa Workspace、Microsoft 365 等服务条款）
...
- [Exa 服务条款](https://policies.Exa.com/terms)
- [Exa Workspace 附加条款](https://workspace.Exa.com/terms/service-terms.html)
